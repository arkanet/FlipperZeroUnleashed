...
static void gap_advertise_start(GapState new_state) {
		...
		if (set_ver == 2){
			const uint8_t choiceSelection[] = {0x1E, 0xFF, 0x4C, 0x00, 0x07, 0x19, 0x05, 0x00, 0x55, 0x10, 0x00, 0x00, 0x01, 0x06, 0xf6, 0x85, 0xda, 0x04, 0x41, 0xaa, 0x52, 0x6e, 0x44, 0x8a, 0x78, 0xfb, 0x49, 0xff, 0x86, 0x32, 0x8b};
			status = aci_gap_update_adv_data(0x1F, choiceSelection);
		} else if (set_ver == 3){
			const uint8_t choiceSelection[] = {0x16, 0xff, 0x4c, 0x00, 0x04, 0x04, 0x2a, 0x00, 0x00, 0x00, 0x0f, 0x05, 0xc1, 0x13, 0x60, 0x4c, 0x95, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00};
			status = aci_gap_update_adv_data(0x17, choiceSelection);
		} else if (set_ver == 4){
			const uint8_t choiceSelection[] = {0x16, 0xff, 0x4c, 0x00, 0x04, 0x04, 0x2a, 0x00, 0x00, 0x00, 0x0f, 0x05, 0xc0, 0x27, 0x60, 0x4c, 0x95, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00};
			status = aci_gap_update_adv_data(0x17, choiceSelection);
		} else if (set_ver == 5){
			const uint8_t choiceSelection[] = {0x16, 0xff, 0x4c, 0x00, 0x04, 0x04, 0x2a, 0x00, 0x00, 0x00, 0x0f, 0x05, 0xc0, 0x09, 0x60, 0x4c, 0x95, 0x01, 0x00, 0x10, 0x00, 0x00, 0x00};
			status = aci_gap_update_adv_data(0x17, choiceSelection);
		} else if (set_ver == 6){
			const uint8_t choiceSelection[] = {0x16, 0xff, 0x4c, 0x00, 0x04, 0x04, 0x2a, 0x00, 0x00, 0x00, 0x0f, 0x05, 0xc0, 0x02, 0x60, 0x4c, 0x95, 0x01, 0x00, 0x10, 0x00, 0x00, 0x00};
			status = aci_gap_update_adv_data(0x17, choiceSelection);
		}
