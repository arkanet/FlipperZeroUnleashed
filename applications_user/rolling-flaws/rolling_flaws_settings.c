...
uint32_t setting_frequency_values[] = {433920000, 868300000, 868400000, 868500000, 868600000, 868700000, 868800000, 868900000};
char *setting_frequency_names[] = {"433.92", "868.30", "868.40", "868.50", "868.60", "868.60", "868.70", "868.80", "868.90"};
